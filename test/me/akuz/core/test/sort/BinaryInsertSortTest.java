...
public final class BinaryInsertSortTest {
	...
	public void test1_quality() {
		...
		for (int experimentNumber=1; experimentNumber<=EXPERIMENT_COUNT; experimentNumber++) {
			...
			if (isNaturalOrder) {
				...
				// unnatural sort
				BinaryInsertSort.sort(list1, comparator);
	...
	public void test2_performance() {
		...
		System.out.println("Binary insert sort speed: " + (System.currentTimeMillis() - ms) + " ms");
